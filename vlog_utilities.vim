...
command -nargs=* AutoPort       :0,$ !perl $VLOG_AIDE_HOME/src/auto_port.pl <args>
command -nargs=* AutoInf        :0,$ !perl $VLOG_AIDE_HOME/src/auto_inf.pl <args>
command AutoInst                :0,$ !perl $VLOG_AIDE_HOME/src/auto_inst.pl
command AutoDef                 :0,$ !perl $VLOG_AIDE_HOME/src/auto_define.pl
command AutoGen                 :0,$ !perl $VLOG_AIDE_HOME/src/auto_gen.pl
command Flop                    :. !perl $VLOG_AIDE_HOME/src/template.pl flop.v
command -nargs=* Tmp            :. !perl $VLOG_AIDE_HOME/src/template.pl <args>
